...
import {
  ICM_EQUITY, ICM_CLASSES, ICM_COMBO, ICM_CLASS_IDX, ICM_TIE,
  EQUITY_VS_RANDOM, handEquityVsRange, handBreakdownVsRange,
  type HandBreakdown,
} from "./engine/equity";
import { icmEquities, solveIcmPushFold } from "./engine/icm";
...
function App() {
  ...
  // Пот-оддсы и защита от блефа — формулы в src/engine/potodds.ts (там же тесты).
  const potOdds = useMemo(() => computePotOdds(potSize, betSize), [potSize, betSize]);
