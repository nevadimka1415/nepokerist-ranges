...
def build_pack():
    ...
    pack = {
        ...
        # Пуш — оранжевый (агрессия, отличается и от красного «Рейз», и от
        # зелёного «Колл»); Колл — зелёный, как дефолтный «Колл» приложения.
        "actions": [
            {"id": PUSH_ACTION, "color": "#eb6834", "label": "Пуш"},
            {"id": CALL_ACTION, "color": "#2f9e44", "label": "Колл"},
        ],
        ...
        "folders": [
            {"id": "pack-pf-btn", "name": "Баттон: пуш (BTN)", "color": "#eb6834",
             "folders": [], "items": push_items},
            {"id": "pack-pf-bb", "name": "BB: колл против пуша", "color": "#2f9e44",
